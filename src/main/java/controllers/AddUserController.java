...
public class AddUserController {
    ...
    private void handleRegisterUser() {
        ...
        if (firstName.isEmpty() || lastName.isEmpty() || email.isEmpty() || password.isEmpty() || confirmPassword.isEmpty()
                || gender == null || dateOfBirth == null || moduleName.isEmpty()|| role.isEmpty()) {
        ...
        // Creating User
        User user = new User(moduleName, firstName, lastName, email, password, gender, role, bio, phoneNumber, profilePicture, dateOfBirth);
