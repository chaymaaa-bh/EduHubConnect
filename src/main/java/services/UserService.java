...
public class UserService implements IService<User> {
    ...
    public void create(User user) throws SQLException {
        String sql = "INSERT INTO Users (first_name, last_name, email, password, date_of_birth, gender,role,bio,phone_number,profile_picture,module_id) VALUES (?, ?, ?, ?, ?,?,?,?,?,?,?)";
        ...
        ps.setInt(11, user.getModule_id());
        ps.executeUpdate();
    ...
    public void update(User user) throws SQLException {
        String sql = "UPDATE Users SET first_name = ?, last_name = ?, email = ?, password = ?, date_of_birth = ?, gender = ?, role = ?, bio = ?, phone_number = ?, profile_picture = ?, module_id = ? WHERE user_id = ?";
    ...
    public List<User> read() throws SQLException {
        ...
        while (rs.next()) {
            ...
            user.setModule_id(rs.getInt("module_id"));
            users.add(user);
        }
        return users;
    }
    ...
    private User extractUserFromResultSet(ResultSet rs) throws SQLException {
        ...
        return new User(user_id, module_id, first_name, last_name, email, password, gender, role, bio, phone_number, profile_picture, date_of_birth);
    }
